...
sass('./src/assets/sass/main.scss', './dist/assets/styles/main.css');
sass('./src/assets/sass/main.scss', './src/assets/styles/main.css');
...
*/
  ...
  config.addPassthroughCopy('src/assets/libs/');
